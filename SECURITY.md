...
If you find a security vulnerability in SONARE, please report it through [GitHub's private vulnerability reporting](https://github.com/iuryrdns/SONARE/security/advisories/new). This keeps the details private while we work on a fix.
